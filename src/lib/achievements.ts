...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  // ── Book completion achievements ──────────────────────────────────────────
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '01-genesis', 50),
        progressValue: Math.min(v, 50),
        target: 50,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '28-psalms', 151),
        progressValue: Math.min(v, 151),
        target: 151,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '29-proverbs', 24),
        progressValue: Math.min(v, 24),
        target: 24,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '35-isaiah', 66),
        progressValue: Math.min(v, 66),
        target: 66,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '16-enoch', 42),
        progressValue: Math.min(v, 42),
        target: 42,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '55-matthew', 28),
        progressValue: Math.min(v, 28),
        target: 28,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '58-john', 21),
        progressValue: Math.min(v, 21),
        target: 21,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '59-act', 28),
        progressValue: Math.min(v, 28),
        target: 28,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: isBookComplete(p.chaptersRead, '81-revelation', 22),
        progressValue: Math.min(v, 22),
        target: 22,
      }
    },
  },
  ...
  // ── Testament completions ─────────────────────────────────────────────────
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: v >= ntTotalChapters,
        progressValue: Math.min(v, ntTotalChapters),
        target: ntTotalChapters,
      }
    },
  },
  {
    ...
    check: (p) => {
      ...
      return {
        unlocked: v >= otTotalChapters,
        progressValue: Math.min(v, otTotalChapters),
        target: otTotalChapters,
      }
    },
  },
]
