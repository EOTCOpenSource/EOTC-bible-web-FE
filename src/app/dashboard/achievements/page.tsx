...
export default function AchievementsPage() {
  ...
  const nearlyThere = achievements.filter((a) => !a.unlocked && a.progressValue / a.target >= 0.6)
  ...
  return (
    <div className="flex w-full flex-col gap-6 py-4 md:py-8">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Track your spiritual reading journey
          </p>
        </div>
      </div>

      {/* ── Overview Hero ──────────────────────────────────────── */}
      <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-[#4C0E0F] to-[#7a1a1c] p-5 text-white shadow-lg dark:border-neutral-800">
          ...
          <div className="flex items-center gap-5">
            ...
            >
              <div className="flex flex-col items-center">
                <span className="text-xl leading-none font-black">{totalPct}%</span>
                <span className="text-[9px] tracking-wide uppercase opacity-70">done</span>
              </div>
            </CircularProgress>
          ...
          <div className="grid flex-1 grid-cols-2 gap-3 sm:grid-cols-2">
            <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm">
              <div className="mb-1 flex items-center gap-1.5">
                ...
                <span className="text-[11px] tracking-wide uppercase opacity-70">Chapters</span>
              </div>
            ...
            <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm">
              <div className="mb-1 flex items-center gap-1.5">
                ...
                <span className="text-[11px] tracking-wide uppercase opacity-70">Streak</span>
              </div>
            ...
            <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm">
              <div className="mb-1 flex items-center gap-1.5">
                ...
                <span className="text-[11px] tracking-wide uppercase opacity-70">Best</span>
              </div>
            ...
            <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm">
              <div className="mb-1 flex items-center gap-1.5">
                ...
                <span className="text-[11px] tracking-wide uppercase opacity-70">Platinum</span>
              </div>
      ...
      {!isLoading && nextUp.length > 0 && (
        <div>
          <div className="mb-3 flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold tracking-wide text-black uppercase dark:text-white">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            {nextUp.map((a, i) => {
              ...
              return (
                <div
                  key={a.id}
                  className={`relative flex flex-col items-center gap-3 rounded-2xl border p-4 text-center transition-all hover:shadow-md ${
                    i === 0
                      ? 'border-orange-200 bg-orange-50 dark:border-orange-800/50 dark:bg-orange-950/20'
                      : 'border-gray-200 bg-white dark:border-neutral-800 dark:bg-neutral-900/50'
                  }`}
                >
                  {i === 0 && (
                    <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 rounded-full bg-orange-500 px-2.5 py-0.5 text-[10px] font-bold tracking-wide text-white uppercase">
                      Closest
                    </span>
                  )}
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center gap-3 py-14 text-center">
          ...
          <button
            ...
            className="rounded-full bg-gray-100 px-4 py-1.5 text-sm text-gray-500 hover:bg-gray-200 dark:bg-neutral-800 dark:text-gray-400 dark:hover:bg-neutral-700"
          >
            Clear filters
          </button>
        </div>
      ...
      {!isLoading && (
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900/50">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <div
                key={label}
                className="flex flex-col items-center gap-1 rounded-xl bg-gray-50 p-3 text-center dark:bg-neutral-800/50"
              >
                <span className="text-2xl">{icon}</span>
                <p className="text-xl font-black text-black dark:text-white">{value}</p>
                <p className="text-[10px] leading-tight text-gray-400">{sub}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-4 border-t border-gray-100 pt-4 dark:border-neutral-800">
            <Link
              href="/read-online"
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#4C0E0F] py-2.5 text-sm font-semibold text-white transition-colors hover:bg-red-800"
            >
              Continue Reading
