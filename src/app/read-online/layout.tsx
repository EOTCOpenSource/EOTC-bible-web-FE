      ...
      <div className="flex flex-1 overflow-hidden pt-20">
        <SidebarProvider onOpenChange={toggleReadOnlineSidebar} open={isReadOnlineSidebarOpen}>
          ...
          <div className={clsx('relative flex-1 overflow-y-auto bg-[#FFFDF8] dark:bg-[#1A1A1C]')}>
            <SidebarTrigger
              className={clsx(
                'fixed top-24 z-20 flex h-10 w-10 items-center justify-center rounded-md border border-gray-200 bg-white shadow-sm transition-all duration-200 hover:bg-gray-100 dark:border-neutral-700 dark:bg-[#1A1A1C] dark:text-white dark:hover:bg-neutral-800',
