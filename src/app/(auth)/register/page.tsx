...
export default function RegisterPage() {
  return (
    <div className="md-w-full top-4 left-0 mx-auto max-h-[94vh] scroll-py-9 overflow-y-scroll bg-gray-100 p-2 md:flex md:max-w-5xl md:items-center md:rounded-3xl md:p-6">
