    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-2xl bg-white p-8 shadow-sm md:p-12">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="mb-4 text-xl font-semibold text-gray-900">How We Use Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="mb-4 text-xl font-semibold text-gray-900">Information Sharing</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:eyobgeremew618@gmail.com" className="text-[#621B1C] hover:underline font-medium">
