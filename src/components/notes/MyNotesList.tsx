...
export function MyNotesList({ isExpanded, onToggleExpandAction }: { isExpanded?: boolean; onToggleExpandAction?: () => void }) {
  ...
  return (
    <div 
      className={`rounded-xl border border-gray-200 bg-[#FFFAFA] xs:mb-3 sm:mb-4 md:mb-6 p-3 sm:p-4 md:p-6 shadow-sm transition-all duration-300 w-full mb-2${
        isExpanded ? 'h-full min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[700px] mb-2' : ''
      }`}
    >
